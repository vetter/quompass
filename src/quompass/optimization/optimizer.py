"""NSGA-II multi-objective optimizer for quompass."""
    ...
    *,
    ...
    try:
        ...
        raise ImportError(
            ...
            "Install it with: pip install 'quompass[optimize]' "
    ...
    quompass_problem = FTQREProblem(space)
    problem = quompass_problem.problem
    ...
    from quompass.optimization.callback import ProgressCallback
    ...
    points = _extract_points(res, space, quompass_problem)
