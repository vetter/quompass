"""The 'quompass estimate' CLI command."""
...
def estimate_cmd(
    ...
    import quompass
    from quompass.templates.registry import get_template
    ...
    if template:
        ...
        algorithm = quompass.AlgorithmSpec.from_dict(data)
    else:
        console.print(
    ...
    hw_arg: quompass.HardwareModel | str = hardware
    ...
    qec_arg: quompass.QECScheme | str = qec
