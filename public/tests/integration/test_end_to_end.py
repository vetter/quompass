...
from quompass.core.qec import color_code
from quompass.templates.shor import shor
from quompass.io import load_algorithm, save_estimate, save_yaml
...
class TestEndToEnd:
    ...
    def test_custom_algorithm(self):
        ...
        result = quompass.estimate(spec, hardware="gate_us_e3", qec="surface_code")
        assert result.total_physical_qubits > 0
    ...
    def test_different_hardware_targets(self):
        ...
        spec = shor(n_bits=64)
        r_sc = quompass.estimate(spec, hardware="gate_ns_e3")
        r_ion = quompass.estimate(spec, hardware="gate_us_e3")
