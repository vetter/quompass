...
if TYPE_CHECKING:
    from quompass.exploration.space import ExplorationResult, ParetoFront
    from quompass.exploration.sensitivity import SensitivityResult
    ...
    *,
    ...
    try:
        ...
        raise ImportError(
            ...
            "Install with: pip install quompass[viz]"
        )
